...
; CHECK-NEXT:    b func
;
; CHECK-GI-LABEL: wrapper_func:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    b func
...
; CHECK-NEXT:    b func
;
; CHECK-GI-LABEL: wrapper_func_zero_arg:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    str wzr, [sp, #8]
; CHECK-GI-NEXT:    b func
...
; CHECK-NEXT:    b func
;
; CHECK-GI-LABEL: wrapper_func_overriden_arg:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ldr w8, [sp]
; CHECK-GI-NEXT:    str wzr, [sp]
...
; CHECK-GI-LABEL: wrapper_func_i1:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ldrb w8, [sp, #8]
; CHECK-GI-NEXT:    strb w8, [sp, #8]
; CHECK-GI-NEXT:    b func_i1
...
;
; CHECK-GI-LABEL: wrapper_func_i8:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ldrsb w8, [sp, #8]
; CHECK-GI-NEXT:    strb w8, [sp, #8]
; CHECK-GI-NEXT:    b func_signext_i1
