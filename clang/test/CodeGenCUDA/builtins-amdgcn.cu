...
// CHECK-NEXT:    store ptr [[OUT1]], ptr addrspace(5) [[OUT_ADDR]], align 8
...
// CHECK-NEXT:    store ptr [[TMP1]], ptr addrspace(5) [[DISPATCH_PTR]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr addrspace(5) [[DISPATCH_PTR]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TMP2]], align 4
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr, ptr addrspace(5) [[OUT_ADDR]], align 8
...
// CHECK-NEXT:    [[TMP1:%.*]] = addrspacecast ptr addrspace(4) [[TMP0]] to ptr
// CHECK-NEXT:    store ptr [[TMP1]], ptr addrspace(5) [[QUEUE_PTR]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr addrspace(5) [[QUEUE_PTR]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TMP2]], align 4
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr, ptr addrspace(5) [[OUT_ADDR]], align 8
// CHECK-NEXT:    store i32 [[TMP3]], ptr [[TMP4]], align 4
// CHECK-NEXT:    ret void
...
// CHECK-NEXT:    [[TMP1:%.*]] = addrspacecast ptr addrspace(4) [[TMP0]] to ptr
// CHECK-NEXT:    store ptr [[TMP1]], ptr addrspace(5) [[IMPLICITARG_PTR]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = load ptr, ptr addrspace(5) [[IMPLICITARG_PTR]], align 8
// CHECK-NEXT:    [[TMP3:%.*]] = load i32, ptr [[TMP2]], align 4
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr, ptr addrspace(5) [[OUT_ADDR]], align 8
// CHECK-NEXT:    store i32 [[TMP3]], ptr [[TMP4]], align 4
// CHECK-NEXT:    ret void
...
// CHECK-NEXT:    [[TMP0:%.*]] = load float, ptr addrspace(5) [[SRC_ADDR]], align 4
// CHECK-NEXT:    [[TMP1:%.*]] = atomicrmw fmax ptr addrspace(3) @_ZZ12test_ds_fmaxfE6shared, float [[TMP0]] monotonic, align 4
// CHECK-NEXT:    store volatile float [[TMP1]], ptr addrspace(5) [[X]], align 4
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    store float [[SRC:%.*]], ptr addrspace(5) [[SRC_ADDR]], align 4
// CHECK-NEXT:    store ptr [[SHARED1]], ptr addrspace(5) [[SHARED_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr addrspace(5) [[SHARED_ADDR]], align 8
...
// CHECK-NEXT:    store volatile float [[TMP3]], ptr addrspace(5) [[X]], align 4
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[TMP0:%.*]] = call align 4 dereferenceable(64) ptr addrspace(4) @llvm.amdgcn.dispatch.ptr()
// CHECK-NEXT:    [[TMP1:%.*]] = addrspacecast ptr addrspace(4) [[TMP0]] to ptr
// CHECK-NEXT:    store ptr [[TMP1]], ptr addrspace(5) [[X]], align 8
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:    [[OUT1:%.*]] = load ptr, ptr addrspace(5) [[OUT]], align 8
// CHECK-NEXT:    store ptr [[OUT1]], ptr addrspace(5) [[OUT_ADDR]], align 8
// CHECK-NEXT:    store i64 [[A:%.*]], ptr addrspace(5) [[A_ADDR]], align 8
// CHECK-NEXT:    store i64 [[B:%.*]], ptr addrspace(5) [[B_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load i64, ptr addrspace(5) [[A_ADDR]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = load i64, ptr addrspace(5) [[B_ADDR]], align 8
// CHECK-NEXT:    [[TMP2:%.*]] = call i64 @llvm.amdgcn.icmp.i64.i64(i64 [[TMP0]], i64 [[TMP1]], i32 35)
// CHECK-NEXT:    [[TMP3:%.*]] = load ptr, ptr addrspace(5) [[OUT_ADDR]], align 8
...
// CHECK-NEXT:    [[TMP1:%.*]] = load ptr, ptr addrspace(5) [[OUT_ADDR]], align 8
...
// CHECK-NEXT:    [[TMP3:%.*]] = atomicrmw fmin ptr addrspace(3) [[TMP1]], float [[TMP2]] monotonic, align 4
// CHECK-NEXT:    store volatile float [[TMP3]], ptr addrspace(5) [[X]], align 4
// CHECK-NEXT:    [[TMP4:%.*]] = load ptr, ptr addrspace(5) [[SHARED_ADDR]], align 8
...
// CHECK-NEXT:    store ptr [[X1]], ptr addrspace(5) [[X_ADDR]], align 8
// CHECK-NEXT:    [[TMP0:%.*]] = load ptr, ptr addrspace(5) [[X_ADDR]], align 8
// CHECK-NEXT:    [[TMP1:%.*]] = call i1 @llvm.amdgcn.is.shared(ptr [[TMP0]])
// CHECK-NEXT:    [[STOREDV:%.*]] = zext i1 [[TMP1]] to i8
// CHECK-NEXT:    store i8 [[STOREDV]], ptr addrspace(5) [[RET]], align 1
// CHECK-NEXT:    ret void
//
