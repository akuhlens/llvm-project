...
// AMDGCN-NEXT:    store ptr addrspacecast (ptr addrspace(4) @.str to ptr), ptr addrspace(5) [[S]], align 8
// AMDGCN-NEXT:    [[TMP0:%.*]] = load ptr, ptr addrspace(5) [[S]], align 8
// AMDGCN-NEXT:    [[TMP1:%.*]] = load ptr, ptr addrspace(5) [[S]], align 8
...
// AMDGCNSPIRV-NEXT:    store ptr addrspace(4) addrspacecast (ptr addrspace(1) @.str to ptr addrspace(4)), ptr [[S]], align 8
// AMDGCNSPIRV-NEXT:    [[TMP0:%.*]] = load ptr addrspace(4), ptr [[S]], align 8
// AMDGCNSPIRV-NEXT:    [[TMP1:%.*]] = load ptr addrspace(4), ptr [[S]], align 8
