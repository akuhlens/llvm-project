...
// CHECK-NEXT:    store <2 x half> [[B]], ptr addrspace(5) [[B_ADDR]], align 4
// CHECK-NEXT:    store float [[C]], ptr addrspace(5) [[C_ADDR]], align 4
// CHECK-NEXT:    [[STOREDV:%.*]] = zext i1 [[S]] to i8
// CHECK-NEXT:    store i8 [[STOREDV]], ptr addrspace(5) [[S_ADDR]], align 1
// CHECK-NEXT:    store i32 [[S_INT]], ptr addrspace(5) [[S_INT_ADDR]], align 4
// CHECK-NEXT:    [[TMP0:%.*]] = load <2 x half>, ptr addrspace(5) [[A_ADDR]], align 4
// CHECK-NEXT:    [[TMP1:%.*]] = load <2 x half>, ptr addrspace(5) [[B_ADDR]], align 4
// CHECK-NEXT:    [[TMP2:%.*]] = load float, ptr addrspace(5) [[C_ADDR]], align 4
// CHECK-NEXT:    [[TMP3:%.*]] = load i8, ptr addrspace(5) [[S_ADDR]], align 1
...
// CHECK-NEXT:    store float [[CALL]], ptr addrspace(5) [[X]], align 4
// CHECK-NEXT:    [[TMP4:%.*]] = load <2 x half>, ptr addrspace(5) [[A_ADDR]], align 4
// CHECK-NEXT:    [[TMP5:%.*]] = load <2 x half>, ptr addrspace(5) [[B_ADDR]], align 4
// CHECK-NEXT:    [[TMP6:%.*]] = load float, ptr addrspace(5) [[C_ADDR]], align 4
// CHECK-NEXT:    [[TMP7:%.*]] = load i32, ptr addrspace(5) [[S_INT_ADDR]], align 4
...
// CHECK-NEXT:    store float [[CALL1]], ptr addrspace(5) [[Y]], align 4
// CHECK-NEXT:    [[TMP8:%.*]] = load float, ptr addrspace(5) [[X]], align 4
// CHECK-NEXT:    [[TMP9:%.*]] = load float, ptr addrspace(5) [[Y]], align 4
