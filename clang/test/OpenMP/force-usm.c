...
// CHECK-USM-NEXT:    store ptr [[DYN_PTR]], ptr addrspace(5) [[DYN_PTR_ADDR]], align 8
// CHECK-USM-NEXT:    store ptr [[GI]], ptr addrspace(5) [[GI_ADDR]], align 8
// CHECK-USM-NEXT:    [[TMP0:%.*]] = load ptr, ptr addrspace(5) [[GI_ADDR]], align 8
...
// CHECK-DEFAULT-NEXT:    store ptr [[DYN_PTR]], ptr addrspace(5) [[DYN_PTR_ADDR]], align 8
// CHECK-DEFAULT-NEXT:    store ptr [[GI]], ptr addrspace(5) [[GI_ADDR]], align 8
// CHECK-DEFAULT-NEXT:    [[TMP0:%.*]] = load ptr, ptr addrspace(5) [[GI_ADDR]], align 8
