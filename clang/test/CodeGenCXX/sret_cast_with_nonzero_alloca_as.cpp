...
// CHECK-NEXT:    store i8 [[X]], ptr addrspace(5) [[X_ADDR]], align 1
// CHECK-NEXT:    store i8 [[Y]], ptr addrspace(5) [[Y_ADDR]], align 1
// CHECK-NEXT:    [[TMP0:%.*]] = load i8, ptr addrspace(5) [[X_ADDR]], align 1
...
// CHECK-NEXT:    [[TMP1:%.*]] = load i8, ptr addrspace(5) [[Y_ADDR]], align 1
